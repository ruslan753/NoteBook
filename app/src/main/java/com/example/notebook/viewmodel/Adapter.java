...
import com.example.notebook.view.SecondActivity;
...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public Adapter(SecondActivity context, SecondActivity activity, List<NoteBook> notesList) {
    }
    ...
    public Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.notes__recycler_view, parent, false);
